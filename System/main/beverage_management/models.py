...
class RequisitionForm(models.Model):
    ...
    date_needed = models.DateField(null=True, blank=True, help_text="When the items are required")
    # ---------------------------
...
class UserActivityLog(models.Model):
    ...
    action = models.CharField(max_length=255)  # e.g., "User Login", "Created PO", "Deleted User"
    details = models.TextField(blank=True, null=True) # e.g., "PO #1234 created for Supplier X"
    ip_address = models.GenericIPAddressField(null=True, blank=True)
    timestamp = models.DateTimeField(auto_now_add=True)
